...
final class Class40 {
    ...
    public Class40(int i, int j, int k, int l, int i1, int j1, int k1,
        ...
        for (int j8 = 0; j8 < j7; j8++) {
            ...
            if (k9 < 4) k9 = (k9 - k1) & 3;
            if (i10 < 4) i10 = (i10 - k1) & 3;
            if (k10 < 4) k10 = (k10 - k1) & 3;
            ...
            if (l8 == 0) {
                ...
                if (anIntArray682 != null) anIntArray682[j8] = -1;
            } else {
                anIntArray676[j8] = ai2[k9];
                anIntArray677[j8] = ai2[i10];
                anIntArray678[j8] = ai2[k10];
                if (anIntArray682 != null) anIntArray682[j8] = i1;
            }
        }

        int i9 = Math.min(Math.min(i3, Math.min(l2, Math.min(l, k2))), Integer.MAX_VALUE);
        int l9 = Math.max(Math.max(i3, Math.max(l2, Math.max(l, k2))), Integer.MIN_VALUE);
        i9 /= 14;
        l9 /= 14;
    }
