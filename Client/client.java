...
public class client extends RSApplet {
	...
	public byte[] getModel(int Index) {
		try {
			File Model = new File("C:/SoulSplit1/model/"+Index+".gz");
	...
	public void preloadModels() {
		File file = new File("C:/SoulSplit1/Raw/");
		File[] fileArray = file.listFiles();
		for(int y = 0; y < fileArray.length; y++) {
			String s = fileArray[y].getName();
			byte[] buffer = ReadFile("C:/SoulSplit1/Raw/"+s);
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
 ...
 //	   myPassword = "";
	...
	private void loadTitleScreen() {
		...
		drawLoadingText(10, "Loading StoneGuide...");
		if(!aBoolean831) {
			drawFlames = true;
			aBoolean831 = true;
	...
	private void loadingStages() {
		if(lowMem && loadingStage == 2 && ObjectManager.anInt131 != plane) {
			aRSImageProducer_1165.initDrawingArea();
			aTextDrawingArea_1271.drawText(0, "StoneGuide 1.0", 151, 257);
	...
	void drawLoadingText(int i, String s)
	{
		...
		char c1 = '\310';
		byte byte1 = 20;
		chatTextDrawingArea.drawText(0xffffff, "StoneGuide 1.0", c1 / 2 - 26 - byte1, c / 2);
		int j = c1 / 2 - 18 - byte1;
...
//	entityMessage(npc);
	...
	void startUp()
	{
		drawLoadingText(20, "Loading StoneGuide...");
 ...
 //		   return;
		...
		if(signlink.cache_dat != null)
		{
			...
			drawLoadingText(60, "Loading StoneGuide...");
			...
			drawLoadingText(65, "Loading StoneGuide...");
			...
			drawLoadingText(70, "Loading StoneGuide...");
			...
			if(decompressors[0] != null)
			{
				drawLoadingText(75, "Loading StoneGuide...");
			...
			drawLoadingText(80, "Loading StoneGuide...");
			...
			drawLoadingText(83, "Loading StoneGuide...");
			Texture.method368(streamLoader_3);
			Texture.method372(0.80000000000000004D);
			Texture.method367();
			drawLoadingText(86, "Loading StoneGuide...");
			...
			drawLoadingText(100, "Loading StoneGuide...");
 ...
 //			   return new DataInputStream((new URL(getCodeBase(), s)).openStream());
	...
	private void drawLoginScreen(boolean flag)
	{
		...
		if(loginScreenState == 0)
		{
			...
			i = c1 / 2 - 20;
			chatTextDrawingArea.method382(0xffff00, c / 2, "StoneGuide 1.0", i, true);
			i += 30;
			int l = c / 2 - 80;
			int k1 = c1 / 2 + 20;
