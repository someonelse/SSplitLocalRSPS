...
public final class Background extends DrawingArea {
    ...
    public Background(StreamLoader streamLoader, String s, int i) {
        // Read the data and index streams using modern Java type inference
        var stream = new Stream(streamLoader.getDataForName(s + ".dat"));
        var stream_1 = new Stream(streamLoader.getDataForName("index.dat"));
    ...
    public void method356() {
        anInt1456 /= 2;
        anInt1457 /= 2;
        var abyte0 = new byte[anInt1456 * anInt1457];
        int i = 0;
    ...
    public void method358() {
        var abyte0 = new byte[anInt1452 * anInt1453];
        int j = 0;
