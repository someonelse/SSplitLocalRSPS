...
import java.awt.*;
import java.awt.loadedImage.PixelGrabber;
import java.awt.loadedImage.*;
...
public final class Sprite extends DrawingArea {
    ...
    public Sprite(byte imageData[], Component component) {
        try {
            //Image loadedImage = Toolkit.getDefaultToolkit().getImage(location+"mopar.jpg");
            Image loadedImage = Toolkit.getDefaultToolkit().createImage(imageData);
            MediaTracker mediaTracker = new MediaTracker(component);
            mediaTracker.addImage(loadedImage, 0);
            mediaTracker.waitForAll();
            myWidth = loadedImage.getWidth(component);
            myHeight = loadedImage.getHeight(component);
            anInt1444 = myWidth;
            anInt1445 = myHeight;
            anInt1442 = 0;
            anInt1443 = 0;
            myPixels = new int[myWidth * myHeight];
            PixelGrabber pixelgrabber = new PixelGrabber(loadedImage, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
        ...
        public Sprite(String img, int width, int height) {
            try {
                Image loadedImage = Toolkit.getDefaultToolkit().createImage(FileOperations.ReadFile(img));
                myWidth = width;
                myHeight = height;
                anInt1444 = myWidth;
                anInt1445 = myHeight;
            ...
            public Sprite(String img) {
                try {
                    Image loadedImage = Toolkit.getDefaultToolkit().getImage(location + img + ".png");
                    ImageIcon sprite = new ImageIcon(loadedImage);
                                ...
                                if(i != 0 && i != -1)
                                {
                                    ...
                                    if(i != 0 && i != -1) {
                                        ...
                                        int j1, int k1, int l1)
                                        {
                                            ...
                                            private void method355(int ai[], int i, byte imageData[], int j, int ai1[], int k,
