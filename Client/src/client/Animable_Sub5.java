...
final class Animable_Sub5 extends Animable {
    ...
    public Model getRotatedModel() {
        ...
        if (aAnimation_1607 != null) {
            int k = clientInstance.loopCycle - anInt1608;
            ...
            anInt1608 = clientInstance.loopCycle - k;
            if (aAnimation_1607 != null)
        ...
        if (class46 == null) {
            ...
            return class46.method578(
                anInt1611, anInt1612,
                anInt1603, anInt1604, anInt1605, anInt1606,
                j
            );
        }
    }
    ...
    private ObjectDef method457() {
        ...
        if (anInt1601 != -1) {
            ...
            int j1 = clientInstance.anIntArray1232[i1 - l];
    ...
    public Animable_Sub5(
        ...
        if (l1 != -1) {
            ...
            anInt1599 = 0;
            anInt1608 = clientInstance.loopCycle;
