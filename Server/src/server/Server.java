...
public class Server {
	...
	public static void main(java.lang.String args[]) throws NullPointerException, IOException {
		...
		// bind login port (43594)
		acceptor.bind(
		  new InetSocketAddress(Config.SERVER_IP, Config.SERVER_PORT),
		  connectionHandler, sac
		);
		// bind game  port (43595)
		acceptor.bind(
		  new InetSocketAddress(Config.SERVER_IP, Config.SERVER_PORT + 1),
		  connectionHandler, sac
		);

		// Now log them both
		for (SocketAddress addr : acceptor.getManagedServiceAddresses()) {
		 ...
		 */
		System.out.println(
			    "Server listening on " + Config.SERVER_IP + ":" + Config.SERVER_PORT
			);
		/**
		 * Main Server Tick
		 */
