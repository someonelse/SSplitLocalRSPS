...
public class Config {
	...
	public static final int START_LOCATION_X = 3087; //Start Here		 edge spawn 3094/3469
	...
	public static final int MELEE_EXP_RATE = 125; // damage * exp rate
	...
	**/
	// modern
	public static final int HOMEPLACE_X = 2811;
	public static final int HOMEPLACE_Y = 3440;
	public static final String HOMEPLACE = "";
	...
	/**
	* Skill Experience Multipliers //all 0's removed
	*/	
