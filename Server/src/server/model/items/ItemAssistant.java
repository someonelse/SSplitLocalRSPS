...
return;
	...
	**/
	public void addPVP(){
Client o = (Client) Server.playerHandler.players[c.killerId];
if (c.isInArd() && Misc.random(250) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, randomDrop(), c.getX(), c.getY(), 1, c.killerId);
}
if (c.isInArd() && Misc.random(90) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, GoodDrop(), c.getX(), c.getY(), 1, c.killerId);
}
if (c.isInArd() && Misc.random(9) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, LowDrop(), c.getX(), c.getY(), 1, c.killerId);
}
if (c.isInFala() && Misc.random(250) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, randomDrop(), c.getX(), c.getY(), 1, c.killerId);
}
if (c.isInFala() && Misc.random(90) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, GoodDrop(), c.getX(), c.getY(), 1, c.killerId);
}
if (c.isInFala() && Misc.random(20) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, MedDrop(), c.getX(), c.getY(), 1, c.killerId);
}
if (c.isInFala() && Misc.random(9) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, LowDrop(), c.getX(), c.getY(), 1, c.killerId);
}
}
...
if (c.playerRights == 3){
c.sendMessage("Co's don't lose items.");
return;
}
if (c.isInArd() && Misc.random(200) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, randomDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, MedDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, LowDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
...
if (c.isInArd() && Misc.random(5) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, MedDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, LowDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
...
if (c.isInArd() && c.getPA().getWearingAmount() < 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
...
if (c.isInArd() && Misc.random(3) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
...
if (c.isInArd() && Misc.random(3) == 3 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
...
if (c.isInArd() && Misc.random(3) == 2 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
...
if (c.isInFala() && Misc.random(200) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, randomDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, MedDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, LowDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
...
if (c.isInFala() && Misc.random(5) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, MedDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, LowDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
...
if (c.isInFala() && c.getPA().getWearingAmount() < 4 && c.duelStatus < 1){
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
Server.itemHandler.createGroundItem(o, FoodDrop(), c.getX(), c.getY(), 1, c.killerId);
...
if (c.isInFala() && Misc.random(3) == 1 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
...
if (c.isInFala() && Misc.random(3) == 3 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
...
if (c.isInFala() && Misc.random(3) == 2 && c.getPA().getWearingAmount() > 4 && c.duelStatus < 1 && o.getPA().getWearingAmount() > 4 && c.duelStatus < 1){
					...
					if(targetSlot == 10 || targetSlot == 7 || targetSlot == 5 || targetSlot == 4 || targetSlot == 0 || targetSlot == 9 || targetSlot == 10) {
						...
						if(c.Donatorreq > 0) {
							if(c.isDonator < c.Donatorreq) {
								...
								c.sendMessage("or go to www.donate.soulsplit.com");
								canWearItem = false;
							}
						}
