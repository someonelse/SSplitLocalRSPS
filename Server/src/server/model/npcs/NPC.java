...
public class NPC {
    ...
    public void updateNPCMovement(Stream str) {
        if (direction == -1) {
            ...
            if (updateRequired) str.writeBits(2, 0);
        } else {
            str.writeBits(1, 1);
            str.writeBits(2, 1);
    ...
    public void appendNPCUpdateBlock(Stream str) {
        ...
        if (forcedChatRequired) updateMask |= 0x1;
        if (hitUpdateRequired) updateMask |= 0x40;
        if (FocusPointX != -1) updateMask |= 0x4;
