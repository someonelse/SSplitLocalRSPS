...
public class ShopAssistant {
    ...
    // Updates all players viewing the same shop
    public void updatePlayerShop() {
        for (int i = 1; i < Config.MAX_PLAYERS; i++) {
            if (Server.playerHandler.players[i] != null) {
                if (Server.playerHandler.players[i].isShopping
                        && Server.playerHandler.players[i].myShopId == c.myShopId && i != c.playerId) {
    ...
    // Resets the shop interface for the player
    ...
    // Gets the shop value for an item
    ...
    // Sends the price of an item to the player (when examining)
    ...
    // Sends the sell price of an item to the player
    ...
    public boolean buyItem(int itemID, int fromSlot, int amount) {
        ...
        if (amount > 0) {
            ...
            for (int i = amount; i > 0; i--) {
                ...
                } else if (c.myShopId != 11 && c.myShopId != 29 && c.myShopId != 30 && c.myShopId != 31
                        && c.myShopId != 47) {
    ...
    // Handles other types of shops (Soul Split, etc.)
    ...
    public int[] skillCapes = { 9747, 9753, 9750, 9768, 9756, 9759, 9762, 9801, 9807, 9783, 9798, 9804, 9780, 9795,
            9792, 9774, 9771, 9777, 9786, 9810, 9765 };
